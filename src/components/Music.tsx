...
const Music = () => {
  ...
  const tracks = [
    {
      title: "MI MAR", 
      description: "Passionate composition inspired by the sea",
      file: "https://ik.imagekit.io/gr46cssvu/Ehab%20-%20MI%20MAR%20-%20Mastered.mp3?updatedAt=1757137037033"
    },
    {
      title: "Haze",
      description: "Atmospheric piece with mystical undertones", 
      file: "https://ik.imagekit.io/gr46cssvu/Ehab%20-Haze%20-mix%20-%20Mastered.mp3?updatedAt=1757137037383"
    },
    {
      title: "Tremolo Bm",
      description: "Technical showcase featuring tremolo technique",
      file: "https://ik.imagekit.io/gr46cssvu/Tremolo%20Bm.m4a?updatedAt=1757137035920"
    },
    {
      title: "Tuesday Night",
      description: "Collaborative piece with rhythmic loops",
      file: "https://ik.imagekit.io/gr46cssvu/Tuesday%20night%20loop.m4a?updatedAt=1757137036788"
    },
    {
      title: "Bulerías de Alma",
      description: "Traditional flamenco bulerías with soulful expression",
      file: "https://ik.imagekit.io/gr46cssvu/Ehab%20-%20Buleri%CC%81as%20de-alma.m4a?updatedAt=1757137036286"
    }
  ];
  ...
  const handleSkipBack = () => {
    if (currentTrack > 0) {
      handleTrackSelect(currentTrack - 1);
    }
  };
    ...
    <section id="music" className="section-padding bg-background py-24 md:py-32">
      <div className="container-max">
        ...
        <p className="text-xl md:text-2xl text-muted-foreground text-center mb-16 max-w-4xl mx-auto font-inter">
          Flamenco compositions that blend traditional Spanish forms with jazz, blues, oriental, and classical music. Each piece tells a story of passion and artistry.
        </p>
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <span className="text-sm text-muted-foreground">
                      {currentTrack === index && duration ? formatTime(duration) : "--:--"}
                    </span>
                  </div>
                </div>
              ))}
