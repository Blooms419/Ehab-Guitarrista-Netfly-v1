...
const LivePerformances = () => {
  ...
  const liveVideoRef = useVideoManager(true); // Enable autoplay
  ...
  const performancePhotos = [
    {
      url: "/lovable-uploads/8417eead-347b-4735-ad12-698254ce88d7.png",
      title: "Wedding Ensemble",
      description: "Elegant quartet with violin, guitars, and upright bass"
    },
    {
      url: "/lovable-uploads/a526d375-a627-4e2d-82d3-7471807434d9.png",
